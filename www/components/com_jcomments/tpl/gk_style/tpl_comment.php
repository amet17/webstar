...
?>
     ...
     <a class="edit" href="#" onclick="jcomments.editComment(<?php echo $comment->id; ?>);return false;"><?php echo $text; ?></a>
...
?>
     ...
     <a class="delete" href="#" onclick="if (confirm('<?php echo JText::_('CONFIRM_DELETE'); ?>')){jcomments.deleteComment(<?php echo $comment->id; ?>);}return false;"><?php echo $text; ?></a>
     <?php
			}
...
?>
     ...
     <a class="<?php echo $el_class; ?>" href="#" onclick="jcomments.publishComment(<?php echo $comment->id; ?>);return false;"><?php echo $text; ?></a>
...
?>
     ...
     <a class="ip" href="#" onclick="jcomments.go('http://www.ripe.net/perl/whois?searchtext=<?php echo $comment->ip; ?>');return false;"><?php echo $text; ?></a>
...
?>
<span class="comments-vote"> <span id="comment-vote-holder-<?php echo $comment->id; ?>">
<?php
