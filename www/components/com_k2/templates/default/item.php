	  ...
	  <!-- Item social links -->
		<div class="itemSocialLinksBlock">
			...
			<ul class="itemSocialLinks">
				<li><a class="googlebuzz" title="<?php echo JText::_("Отправить в  Google Buzz"); ?>" href="http://www.google.com/buzz/post?url=<?php echo $this->item->socialLink; ?>&amp;message=<?php echo urlencode($this->item->title); ?>" target="_blank"><span><?php echo JText::_("Add to Google Buzz"); ?></span></a></li>
				<li><a class="facebook" title="<?php echo JText::_("Отправить в Facebook"); ?>" href="http://www.facebook.com/sharer.php?u=<?php echo $this->item->socialLink; ?>&amp;t=<?php echo urlencode($this->item->title); ?>" target="_blank"><span><?php echo JText::_("Add to Facebook"); ?></span></a></li>
				 <li><a onclick="_gaq.push(['_trackEvent', 'Social Networks', 'Share', 'Twitter']);" href="http://twitter.com/home?status=<?php echo urlencode($this->item->title); ?>+<?php echo $this->item->socialLink; ?>" class="twitter" target="_blank" rel="small"></a></li>
                 <li><a class="vkontakte" href="http://vkontakte.ru/share.php?url=<?php echo $this->item->socialLink; ?>" target="_blank"></a></li>
                <li class="clr"></li>
			</ul>
			<div class="clr"></div>
		</div>
