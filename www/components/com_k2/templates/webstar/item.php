  ...
  <div class="itemBody">
	  ...
	  <div class="itemExtraFields">
	  	...
	  	<ul>
			...
			<li class="extrafield-<?php echo $extraField->id; ?> <?php echo ($key%2) ? "odd" : "even"; ?> type<?php echo ucfirst($extraField->type); ?> group<?php echo $extraField->group; ?>">
  ...
  <div class="itemLinks">
	  ...
	  <div class="itemTagsBlock">
		  ...
		  <ul class="itemTags">
		    ...
		    <li><noindex><a rel="nofollow" href="<?php echo $tag->link; ?>"><?php echo $tag->name; ?></a></noindex></li>
		    <?php endforeach; ?>
		  </ul>
		  <div class="clr"></div>
	  </div>
	  ...
	  <!-- Item social links share42-->
		<div class="itemSocialLinksBlock">
			<span><?php echo JText::_("Social sharing"); ?></span>
              ...
              <script type="text/javascript">share42('/share42/','<? function getLink() { return $this->item->socialLink; } ?>','<? function getTitle() { return $this->item->title; } ?>')</script>
