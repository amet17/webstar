...
|| #################################################################### ||
\*======================================================================*/
#top_menu{float:right; margin:42px auto 0 auto; display:block; position:relative; z-index:9999}
#horiznav{height:35px; z-index:500; float:right}
#horiznav ul{list-style:none; line-height:35px; padding-top:0px}
#horiznav ul li{position:relative; margin:0 0 0 10px}
#horiznav ul li ul li{margin:0}
#horiznav a{text-transform:uppercase; display:block; cursor:pointer; height:35px; padding:0px 0px 0px 25px; margin:0px 0px 0px 0px; font:bold 10px/35px Tahoma}
...
#horiznav li ul{position:absolute; left:-999em; height:auto; font-weight:normal; border-width:0; margin:-2px 0 0 0px; padding:0; border-bottom:none}
...
a.mainlevel{display:block; font-size:12px; height:26px; line-height:20px; padding-top:5px; text-decoration:none; text-indent:24px}
...
.k2CategoriesListBlock ul li:hover{list-style-type:none; background-image:none; padding:0; text-align:left; margin-left:0px; margin-right:0px}
.k2CategoriesListBlock ul li a{height:26px; line-height:20px; text-decoration:none; display:block; font-size:11px; text-decoration:none; text-indent:0px; padding-top:5px}
.k2CategoriesListBlock ul.level0 a{padding:5px 0 0 20px}
