...
#centerbottom{}
#logo{background:url(../images/darkorange/logo.png) no-repeat 0px 0px}
#yjsg2{background:#202020 url(../images/darkorange/yjsg2_inset.gif) repeat-x left top}
#yjsg2 .yjsquare{color:#fff}
#footer{background:#191919 url(../images/darkorange/footer_inset.gif) repeat-x left top; color:#fff}
#footer a:link, 
...
.contentheading a:link, 
.contentheading a:visited{color:#ff4c00; text-shadow:1px 1px #000}
...
input#email:hover{background:#383838; border:1px solid #ff4c00}

.button{color:#fff}

.button, .validate{background:url(../images/darkorange/ybuttons.gif) repeat-x left top; border-top:none; border-bottom:1px solid #212121; border-right:1px solid #212121; border-left:1px solid #000; color:#ff4c00; text-transform:lowercase; text-shadow:1px 1px #000}
a.button:link, 
a.button:visited, 
...
a.readon:link, a.readon:visited{background:url(../images/darkorange/readon_ll.gif) no-repeat left center; color:#fff; text-transform:uppercase; font-size:10px; font-weight:bold; text-shadow:1px 1px #000}

.readon span{background:url(../images/darkorange/readon_rl.gif) no-repeat right center}
a.readon:hover, .pagenavbar a:hover{color:#ff4c00}

#midblock a.readon:link, 
#midblock a.readon:visited{margin:0 0 0 0; color:#ff4c00; text-transform:lowercase; background:url(../images/darkorange/readm_arrow.jpg) no-repeat left top}
#midblock a.readon:hover, 
#midblock .pagenavbar a:hover{color:#959494; background:url(../images/darkorange/readm_arrow.jpg) no-repeat left bottom}
#midblock .readon span{background:none; padding:0}

.yjsquare h3{color:#ff4c00; text-shadow:1px 1px #000}
...
#horiznav ul li a{color:#ff4c00; background:url(../images/darkorange/topmenu/normal_l.png) no-repeat left center; text-shadow:1px 1px #000}

#horiznav ul li a:hover, 
#horiznav ul li:hover a, 
#horiznav ul li.sfHover a{color:#fff; background:url(../images/darkorange/topmenu/hover_l.png) no-repeat left center; text-shadow:1px 1px #a83809}
#horiznav li#current a, 
#horiznav li#current a:hover, 
#horiznav li#current:hover a, 
#horiznav li#current.sfHover a, 
#horiznav li.active a{color:#fff; background:url(../images/darkorange/topmenu/active_l.png) no-repeat left center; text-shadow:1px 1px #a83809}
#horiznav li#current, 
#horiznav li#current:hover, 
#horiznav li#current.sfHover, 
#horiznav li.active{background:url(../images/darkorange/topmenu/active_r.png) no-repeat right center}
...
#horiznav li li{border-bottom:1px solid #9c1629}

#horiznav li ul{border-right:none; border-left:none; border-bottom:none; border-top:1px solid #9c1629}
#horiznav li, #horiznav{font-weight:bold; background:none}
#horiznav li{background:url(../images/darkorange/topmenu/normal_r.png) no-repeat right center}
#horiznav ul li:hover, #horiznav ul li.sfHover{background:url(../images/darkorange/topmenu/hover_r.png) no-repeat right center}

#horiznav ul li ul li.haschild a.child, 
#horiznav ul li ul li a.child:hover{background:url(../images/darkorange/topmenu/arrow_right.gif) 95% 50% no-repeat}

#horiznav ul li.active ul li a.child{background:url(../images/darkorange/topmenu/arrow_right.gif) 95% 50% no-repeat}

#mainlevel li a, 
.menu li a, 
a.mainlevel{background:url(../images/darkorange/mainlevel.gif) no-repeat left top}
...
#mainlevel li a:hover, 
#mainlevel a#active_menu:link, #mainlevel a#active_menu:visited, 
.menu li a:hover, .menu li.active a{background:url(../images/darkorange/mainlevel.gif) no-repeat left bottom}
a.sublevel{background:url(../images/darkorange/bodyli.gif) no-repeat 5px 9px}
...
.k2CategoriesListBlock ul li a{background:url(../images/darkorange/mainlevel.gif) no-repeat left top; color:#ff4c00}
.k2CategoriesListBlock ul li a:hover{color:#ff4c00; background:url(../images/darkorange/mainlevel.gif) no-repeat left top}
div.k2CategoriesListBlock ul li.activeCategory a{font-weight:normal; color:#8c8c8c; background:url(../images/darkorange/mainlevel.gif) no-repeat left bottom}
div.k2CategoriesListBlock ul li.activeCategory ul.level1 a{font-weight:normal; color:#ff4c00; background:url(../images/darkorange/mainlevel.gif) no-repeat left top}
div.k2CategoriesListBlock ul li.activeCategory ul.level1 a:hover{font-weight:normal; color:#8c8c8c; background:url(../images/darkorange/mainlevel.gif) no-repeat left bottom}
...
.yjsquare li.active ul li.active a{color:#686C6F; background:url(../images/darkorange/mainlevel.gif) no-repeat left top}
body li{padding-left:15px; background:url(../images/darkorange/bodyli.gif) no-repeat 0px 6px; font-family:Verdana,Arial,Helvetica, sans-serif; font-size:11px; text-decoration:none}
...
#yjsg2 ul li a, 
#yjsg2 ul li a:visited{color:#fff; background:url(../images/darkorange/li_bot_a.gif) no-repeat left bottom}
#yjsg2 ul li a:hover, 
...
#yjsg2 .yjsgxhtml{background:url(../images/darkorange/bot_sep.gif) no-repeat right center}
.readb{background:url(../images/darkorange/readb.gif) no-repeat left center}
...
div.itemRatingForm .formLogLoading{background:url(../images/darkorange/loading.gif) no-repeat left center; height:25px; padding:0 0 0 20px}
div.itemCommentsForm form .formLogLoading{background:url(../images/darkorange/loading2.gif) no-repeat left center}
div.itemToolbar ul li a#fontIncrease img{width:13px; height:13px; background:url(../images/darkorange/font_increase.gif) no-repeat}
div.itemToolbar ul li a#fontDecrease img{width:13px; height:13px; background:url(../images/darkorange/font_decrease.gif) no-repeat}
...
#navigator li.element{background:#ececec url(../images/darkorange/nav_bg.png) repeat-x left bottom}
#navigator li.selected_right{background:#282828}
#navigator li.selected_right div.inner, 
#navigator li.selected_left div.inner{color:#fff; background:#282828 url(../images/darkorange/nav_bg.png) repeat-x left bottom; text-shadow:none}

#navigator li.element{background:#0b0b0b url(../images/darkorange/nav_bg.png) repeat-x left bottom}
...
div.k2FeedIcon a:hover{background:url(../images/darkorange/k2rss.gif) no-repeat 50% 50%}
p.sticky, p.pin, p.clip, 
p.down{background-color:#2D2D2D; border:1px solid #333}
div.blockquote{border:1px solid #333; background-color:#2D2D2D; background:#333 url(../images/darkorange/typ/qlg.gif) no-repeat 0px 2px  !Important}
div.blockquote blockquote{background:url(../images/darkorange/typ/qrg.gif) no-repeat right bottom}
...
.error{color:#C00; background:url(../images/darkorange/typ/error.gif) no-repeat center left}
.message{color:#069; background:url(../images/darkorange/typ/info.gif) no-repeat center left}
.tips{color:#FF5A00; background:url(../images/darkorange/typ/tips.gif) no-repeat center left}
p.sticky{background:#2D2D2D url(../images/darkorange/typ/sticky.gif) no-repeat left center}
p.pin{background:#2D2D2D url(../images/darkorange/typ/pin.gif) no-repeat left center}
p.clip{background:#2D2D2D url(../images/darkorange/typ/clip.gif) no-repeat left center}
p.down{background:#2D2D2D url(../images/darkorange/typ/down.gif) no-repeat left center}
