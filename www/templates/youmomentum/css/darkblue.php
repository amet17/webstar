...
#centerbottom{}
#logo{background:url(../images/darkblue/logo.png) no-repeat 0px 0px}
#yjsg2{background:#202020 url(../images/darkblue/yjsg2_inset.gif) repeat-x left top}
#yjsg2 .yjsquare{color:#fff}
#footer{background:#191919 url(../images/darkblue/footer_inset.gif) repeat-x left top; color:#fff}
#footer a:link, 
#footer a:visited{color:#339bf2}
#footer a:hover, 
#footer a:focus{color:#fff}
#cp a:link, 
#cp a:visited{color:#fff}
#cp a:hover, 
#cp a:focus{color:#339bf2}
a#yjlink:link, 
a#topscroll:link, 
a#yjlink:visited, 
a#topscroll:visited{color:#339bf2}
a#yjlink:hover, 
a#yjlink:focus, 
a#topscroll:hover, 
a#topscroll:focus{color:#fff}

div.itemCommentsForm form input.button{color:#339bf2}

.search{}
.search .inputbox{}

#modlgn_passwd, #modlgn_username{color:#339bf2; border:1px solid #d7d7d6}
#modlgn_passwd{background:#fff}
#modlgn_username{background:#fff}
#mod_login_remember{border:none; padding:0!important}

a:link, a:visited{text-decoration:none; color:#339bf2}
a:focus, a:hover{color:#828181; text-decoration:none}
h1, h3, h4, 
h5, h6, h2{color:#339bf2}
...
.contentheading a:link, 
.contentheading a:visited{color:#339bf2; text-shadow:1px 1px #000}
...
input#email:hover{background:#383838; border:1px solid #339bf2}

.button{color:#fff}

.button, .validate{background:url(../images/darkblue/ybuttons.gif) repeat-x left top; border-top:none; border-bottom:1px solid #212121; border-right:1px solid #212121; border-left:1px solid #000; color:#339bf2; text-transform:lowercase; text-shadow:1px 1px #000}
a.button:link, 
a.button:visited, 
...
.pagenav_prev a, 
.pagenav_next a, 
.pagenavbar a, .back_button a{background:#339bf2; border:1px solid #339bf2; color:#fff}
a.readon:link, a.readon:visited{background:url(../images/darkblue/readon_ll.gif) no-repeat left center; color:#fff; text-transform:uppercase; font-size:10px; font-weight:bold; text-shadow:1px 1px #000}

.readon span{background:url(../images/darkblue/readon_rl.gif) no-repeat right center}
a.readon:hover, .pagenavbar a:hover{color:#339bf2}

#midblock a.readon:link, 
#midblock a.readon:visited{margin:0 0 0 0; color:#339bf2; text-transform:lowercase; background:url(../images/darkblue/readm_arrow.jpg) no-repeat left top}
#midblock a.readon:hover, 
#midblock .pagenavbar a:hover{color:#959494; background:url(../images/darkblue/readm_arrow.jpg) no-repeat left bottom}
#midblock .readon span{background:none; padding:0}

.yjsquare h3{color:#339bf2; text-shadow:1px 1px #000}
.yjsquare h3 span{color:#339bf2}
...
#horiznav ul li a{color:#339bf2; background:url(../images/darkblue/topmenu/normal_l.png) no-repeat left center; text-shadow:1px 1px #000}

#horiznav ul li a:hover, 
#horiznav ul li:hover a, 
#horiznav ul li.sfHover a{color:#fff; background:url(../images/darkblue/topmenu/hover_l.png) no-repeat left center; text-shadow:1px 1px #1466aa}
#horiznav li#current a, 
#horiznav li#current a:hover, 
#horiznav li#current:hover a, 
#horiznav li#current.sfHover a, 
#horiznav li.active a{color:#fff; background:url(../images/darkblue/topmenu/active_l.png) no-repeat left center; text-shadow:1px 1px #1466aa}
#horiznav li#current, 
#horiznav li#current:hover, 
#horiznav li#current.sfHover, 
#horiznav li.active{background:url(../images/darkblue/topmenu/active_r.png) no-repeat right center}
...
#horiznav ul li.sfHover li a, 
#horiznav ul li:hover ul ul li a, 
#horiznav ul li.sfHover ul ul li a{background-color:#339bf2}
...
#horiznav ul li.haschild li#current a:hover{background-color:#339bf2; color:#202020; background-image:none}
...
#horiznav li li{border-bottom:1px solid #1466aa}

#horiznav li ul{border-right:none; border-left:none; border-bottom:none; border-top:1px solid #1466aa}
#horiznav li, #horiznav{font-weight:bold; background:none}
#horiznav li{background:url(../images/darkblue/topmenu/normal_r.png) no-repeat right center}
#horiznav ul li:hover, #horiznav ul li.sfHover{background:url(../images/darkblue/topmenu/hover_r.png) no-repeat right center}

#horiznav ul li ul li.haschild a.child, 
#horiznav ul li ul li a.child:hover{background:url(../images/darkblue/topmenu/arrow_right.gif) 95% 50% no-repeat}

#horiznav ul li.active ul li a.child{background:url(../images/darkblue/topmenu/arrow_right.gif) 95% 50% no-repeat}

#mainlevel li a, 
.menu li a, 
a.mainlevel{background:url(../images/darkblue/mainlevel.gif) no-repeat left top}
...
#mainlevel li a:hover, 
#mainlevel a#active_menu:link, #mainlevel a#active_menu:visited, 
.menu li a:hover, .menu li.active a{background:url(../images/darkblue/mainlevel.gif) no-repeat left bottom}
a.sublevel{background:url(../images/darkblue/bodyli.gif) no-repeat 5px 9px}
...
a.mainlevel, 
#mainlevel li a{color:#339bf2}

.k2CategoriesListBlock ul li a{background:url(../images/darkblue/mainlevel.gif) no-repeat left top; color:#339bf2}
.k2CategoriesListBlock ul li a:hover{color:#339bf2; background:url(../images/darkblue/mainlevel.gif) no-repeat left top}
div.k2CategoriesListBlock ul li.activeCategory a{font-weight:normal; color:#8c8c8c; background:url(../images/darkblue/mainlevel.gif) no-repeat left bottom}
div.k2CategoriesListBlock ul li.activeCategory ul.level1 a{font-weight:normal; color:#339bf2; background:url(../images/darkblue/mainlevel.gif) no-repeat left top}
div.k2CategoriesListBlock ul li.activeCategory ul.level1 a:hover{font-weight:normal; color:#8c8c8c; background:url(../images/darkblue/mainlevel.gif) no-repeat left bottom}
div.k2CategoriesListBlock ul li.activeCategory a:hover{color:#8c8c8c}
.yjsquare li.active ul li a, 
a.sublevel#active_menu{color:#339bf2}
.yjsquare li.active ul li a:hover, 
.yjsquare li.active ul li.active a{color:#686C6F; background:url(../images/darkblue/mainlevel.gif) no-repeat left top}
body li{padding-left:15px; background:url(../images/darkblue/bodyli.gif) no-repeat 0px 6px; font-family:Verdana,Arial,Helvetica, sans-serif; font-size:11px; text-decoration:none}
...
#yjsg2 ul li a, 
#yjsg2 ul li a:visited{color:#fff; background:url(../images/darkblue/li_bot_a.gif) no-repeat left bottom}
#yjsg2 ul li a:hover, 
#yjsg2 ul li a:focus{color:#339bf2}
#bottomout, #topout{background:#303030; color:#aaa}
#bottomout .yjsquare, 
#topout .yjsquare{color:#aaa}
img.border{border:1px #333 solid; background:#2d2d2d}
.dropcap, 
.bignumber{color:#339bf2}
#yjsg2 .yjsgxhtml{background:url(../images/darkblue/bot_sep.gif) no-repeat right center}
.readb{background:url(../images/darkblue/readb.gif) no-repeat left center}
...
div.itemRatingForm .formLogLoading{background:url(../images/darkblue/loading.gif) no-repeat left center; height:25px; padding:0 0 0 20px}
div.itemCommentsForm form .formLogLoading{background:url(../images/darkblue/loading2.gif) no-repeat left center}
div.itemToolbar ul li a#fontIncrease img{width:13px; height:13px; background:url(../images/darkblue/font_increase.gif) no-repeat}
div.itemToolbar ul li a#fontDecrease img{width:13px; height:13px; background:url(../images/darkblue/font_decrease.gif) no-repeat}
...
#navigator li.element{background:#ececec url(../images/darkblue/nav_bg.png) repeat-x left bottom}
#navigator li.selected_right{background:#282828}
#navigator li.selected_right div.inner, 
#navigator li.selected_left div.inner{color:#fff; background:#282828 url(../images/darkblue/nav_bg.png) repeat-x left bottom; text-shadow:none}

#navigator li.element{background:#0b0b0b url(../images/darkblue/nav_bg.png) repeat-x left bottom}
...
div.k2FeedIcon a:hover{background:url(../images/darkblue/k2rss.gif) no-repeat 50% 50%}
p.sticky, p.pin, p.clip, 
p.down{background-color:#2D2D2D; border:1px solid #333}
div.blockquote{border:1px solid #333; background-color:#2D2D2D; background:#333 url(../images/darkblue/typ/qlg.gif) no-repeat 0px 2px  !Important}
div.blockquote blockquote{background:url(../images/darkblue/typ/qrg.gif) no-repeat right bottom}
...
.error{color:#C00; background:url(../images/darkblue/typ/error.gif) no-repeat center left}
.message{color:#069; background:url(../images/darkblue/typ/info.gif) no-repeat center left}
.tips{color:#FF5A00; background:url(../images/darkblue/typ/tips.gif) no-repeat center left}
p.sticky{background:#2D2D2D url(../images/darkblue/typ/sticky.gif) no-repeat left center}
p.pin{background:#2D2D2D url(../images/darkblue/typ/pin.gif) no-repeat left center}
p.clip{background:#2D2D2D url(../images/darkblue/typ/clip.gif) no-repeat left center}
p.down{background:#2D2D2D url(../images/darkblue/typ/down.gif) no-repeat left center}
