<?php
/**
 * $Id: install.xmap.php 132 2010-08-16 01:34:09Z guilleva $
 * $LastChangedDate: 2010-08-15 19:34:09 -0600 (dom, 15 ago 2010) $
...
if ( file_exists( $pathLangFile . $tmp_lng . '.php' )){
    ...
    <table border="0" width="90%">
	    <tr>
		    ...
		    <td width="80%"><b>Xmap 1.2.9 Stable</b></td>
	    </tr>
	    <tr>
		...
		<tr>
			...
			<br> </br>
			<font color="green"><b>Xmap 1.2.9 has been installed successfully! Thank you for using Xmap! Settings can be configured in the <a href="index.php?option=com_xmap">&rarr; component menu</a>!<br /></b><br />
			<br> </br></td>
		</tr>
	    <tr>
	      <td>&nbsp;</td>
