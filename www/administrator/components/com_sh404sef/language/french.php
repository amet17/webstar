...
# Complément de traduction française et corrections Jacky Bondoux alias socrates et Philippe Véron alias vezid  
# 2010-12-23
...
define('COM_SH404SEF_CHK_PERMS','Merci de vérifier les permissions d\'accès aux fichiers, et de contrôler que ce fichier peut être lu.');
...
define('COM_SH404SEF_CONFIRM_ERASE_CACHE', 'Voulez-vous vider le cache URL ? Ceci est toujours recommandé après une modification de la configuration. Pour régénérer le cache, vous devez visiter de nouveau la page d&rsquo;accueil de votre site, ou mieux : créer un sitemap.');
...
<p>Vous avez demandé à visiter <strong>{%sh404SEF_404_URL%}</strong>, mais en dépit de tous nos efforts, nos ordinateurs n\'ont pas réussi à la trouver. Que s\'est-il passé ?</p>
<ul>
<li>le lien sur lequel vous avez cliqué pour arriver ici comportait une erreur</li>
<li>ou bien nous avons effacé ou changé le nom de cette page pour une raison ou une autre</li>
<li>ou encore, quoique bien improbable, vous avez peut être fait une petite faute de frappe en tapant vous-même cette adresse ?</li>
</ul>
<h4>{sh404sefSimilarUrlsCommentStart}Tout n\'est pas perdu : nous pensons que les pages suivantes de notre site peuvent peut-être vous intéresser également :{sh404sefSimilarUrlsCommentEnd}</h4>
...
define('COM_SH404SEF_IMPORT_OK','Les URLs personnalisées ont été importées correctement !');
...
define('COM_SH404SEF_INVALID_URL','URL non valide: ce lien requiert un Itemid valide, mais aucun n\'a pu être trouvé.<br/>SOLUTION: Créez un élément de menu qui pointe vers cet élément. Vous n\'avez pas besoin de le publier, il suffit qu\'il existe.');
...
define('COM_SH404SEF_ADV_MANAGE_URL', 'Traitement des URLs');
define('COM_SH404SEF_ADV_TRANSLATE_URL', 'Traduction des URLs');
define('COM_SH404SEF_ALWAYS_INSERT_ITEMID', 'Toujours ajouter l\'Itemid à l\'URL SEF');
...
define('COM_SH404SEF_ENCODE_URL', 'Encoder les URLs');
define('COM_SH404SEF_FB_INSERT_CATEGORY_ID', 'Insérer identifiant catégorie');
define('COM_SH404SEF_FB_INSERT_CATEGORY_NAME', 'Insérer le nom de la catégorie');
...
define('COM_SH404SEF_GUESS_HOMEPAGE_ITEMID', 'Deviner l\'Itemid sur page d\'accueil');
...
define('COM_SH404SEF_INSERT_GLOBAL_ITEMID_IF_NONE', 'Insérer l\'Itemid du menu si aucun');
...
define('COM_SH404SEF_INSERT_NUMERICAL_ID', 'Insérer un identifiant unique dans l\'URL');
...
define('COM_SH404SEF_INSERT_TITLE_IF_NO_ITEMID', 'Insérer le titre de menu si pas d\'Itemid');
define('COM_SH404SEF_ITEMID_TITLE', 'Gestion de l\'Itemid');
...
define('COM_SH404SEF_STRANGE','Quelque chose de bizarre vient de se produire, et cela n\'aurait pas dû arriver<br />');
...
define('COM_SH404SEF_SUPPORTDESC','Allez sur le site d\'aide de sh404SEF');
...
define('COM_SH404SEF_TT_OLDURL','Vous ne pouvez entrer qu\'une URL relative (ne commençant pas par http://). Ne mettez pas non plus de / au début');
...
define('COM_SH404SEF_TT_ACTIVATE_IJOOMLA_MAG', 'Si <strong>Activé</strong>, et qu\'un paramètre appellé \'ed\' est passé dans l\'URL d\'affichage d\'un article, il sera interprêté comme l\'identifiant d\'un numéro de magazine IJoomla.');
define('COM_SH404SEF_TT_ADV_INSERT_ISO', 'Pour chaque composant installé, et si votre site est multilingue, indiquez si vous voulez insérer le code de langue dans les URLs. Par exemple : www.monsite.com/<b>en</b>/introduction.html. Le code en indique l\'anglais. Notez que le code ne sera jamais inséré pour la langue par défaut du site.');
...
define('COM_SH404SEF_TT_ADV_OVERRIDE_SEF', 'Certains composants sont livrés avec des fichiers d\'extensions sef (sef_ext) destinés au SEF de Joomla, à OpenSEF ou SEF Advanced. Si ce paramètre est placé sur Remplacer extension SEF, l\'extension livrée avec le composant ne sera pas utilisée, mais remplacée par celle de sh404SEF (si elle existe bien sûr). Dans le cas contraire, c\'est l\'extension livrée avec le composant qui sera mise en oeuvre.');
define('COM_SH404SEF_TT_ADV_TRANSLATE_URL', 'Pour chaque composant installé, choisissez si les URLs doivent être traduites ou non. Sans effet si votre site ne comporte qu’une seule langue.');
define('COM_SH404SEF_TT_ALWAYS_INSERT_ITEMID', 'Si activé, l\'Itemid de l\'URL non-sef (ou l\'Itemid de  l\'élément courant du menu si aucun ne figure dans l\'URL non-sef) sera ajouté à la fin de l\'URL sef. A utiliser à la place de Toujours insérer un titre si vous avez plusieurs éléments de menu qui portent le même titre (par exemple un dans le menu principal et un autre dans le menu supérieur).');
define('COM_SH404SEF_TT_ALWAYS_INSERT_MENU_TITLE', 'Si activé, le titre de l\'élément de menu désigné par l\'Itemid figurant dans l\'URL non-sef, ou celui de l\'élément de menu actif à défaut, sera inséré dans l\'URL SEF.');
define('COM_SH404SEF_TT_CB_INSERT_NAME', 'Si <strong>Activé</strong>, le titre de l\'élément de menu qui conduit à Community builder sera systématiquement ajouté au début des URLs sef');
define('COM_SH404SEF_TT_CB_INSERT_USER_ID', 'Si <strong>Activé</strong>, l\'identifiant unique de chaque utilisateur sera ajouté avant son nom <strong>lorsque l\'option précédente est activée</strong>, dans le cas où deux utilisateurs auraient le même nom.');
define('COM_SH404SEF_TT_CB_INSERT_USER_NAME', 'Si <strong>Activé</strong>, le nom de l\'utilisateur sera inséré dans les URLs. <strong>ATTENTION</strong>: ceci entraîne une augmentation significative de la place occupée dans la base de données, et peut ralentir le chargement des pages si vous avez beaucoup d\'utilisateurs inscrits. Si non activé, l\'identifiant de l\'utilisateur continue à être passé au format habituel (....?user=245 par exemple)');
define('COM_SH404SEF_TT_CB_NAME', 'Quand le paramètre précédent est activé, vous pouvez saisir un nom, qui sera alors employé à la place du titre de l\'élément de menu. Notez bien qu\'alors ce nom est invariant, et en particulier qu\'il ne sera pas traduit.');
define('COM_SH404SEF_TT_CB_USE_USER_PSEUDO', 'Si activé, le pseudonyme de l\'utilisateur sera employé au lieu de son nom dans les URL lorsque vous avez activé cette option (voir ci-dessus)');
define('COM_SH404SEF_TT_DEFAULT_MENU_ITEM_NAME', 'Quand le paramètre ci-dessus est activé, vous pouvez saisir un titre ici, qui sera alors employé à la place des titres de menus. Notez bien qu\'alors ce titre est invariant, et en particulier qu\'il ne sera pas traduit.');
define('COM_SH404SEF_TT_ENCODE_URL', 'Si activé, les URLs produites par sh404SEF seront encodées de manière à être compatibles avec les langues ayant des caractères non latin. L\'encodage ressemble à : monsite.com/%34%56%E8%67%12.....');
define('COM_SH404SEF_TT_FB_INSERT_CATEGORY_ID', 'Si activé, le nom de catégorie dans une URL sera toujours précédé de l\'identifiant interne de cette catégorie, ce qui est utile quand plusieurs catégories ont le même nom.');
define('COM_SH404SEF_TT_FB_INSERT_CATEGORY_NAME', 'Si activé, le nom de la categorie du forum est inséré dans l\'URL sef pour tous les liens menant à l\'affichage d\'un post ou d\'une catégorie');
define('COM_SH404SEF_TT_FB_INSERT_MESSAGE_ID', 'Si activé, le sujet du message dans une URL sera toujours précédé de l\'identifiant interne de ce sujet, ce qui est utile quand plusieurs sujets ont le même nom.');
define('COM_SH404SEF_TT_FB_INSERT_MESSAGE_SUBJECT', 'Si activé, le sujet d\'un message sera inséré dans l\'URL sef pour tous les liens menant à l\'affichage de ce message');
define('COM_SH404SEF_TT_FB_INSERT_NAME', 'Si <strong>Activé</strong>, le titre de l\'élément de menu qui conduit à Kunena sera systématiquement ajouté au début des URLs sef');
define('COM_SH404SEF_TT_FB_NAME', 'Quand le paramètre précédent est activé, vous pouvez saisir un nom, qui sera alors employé à la place du titre de l\'élément de menu. Notez bien qu\'alors ce nom est invariant, et en particulier qu\'il ne sera pas traduit.');
define('COM_SH404SEF_TT_FORCE_NON_SEF_HTTPS', 'Si activé, toutes les URLs resteront non sef en cas de passage au mode SSL (HTTPS). Cela permet de fonctionner avec certaines configurations de serveurs SSL partagés');
define('COM_SH404SEF_TT_GUESS_HOMEPAGE_ITEMID', 'Si activé, sur la page d\'accueil, l\'Itemid des URLs menant à des articles (com_content) sera supprimé et remplacé par celui que sh404SEF recherchera. Cela permet d\'éviter que les articles visibles à la fois sur la page d\'accueil et sur une autre page puissent être vus que sur la page d\'accueil.');
define('COM_SH404SEF_TT_IJOOMLA_MAG_NAME', 'Quand le paramètre ci-dessus est activé, vous pouvez saisir un nom, qui sera alors employé à la place du titre de l\'élément de menu. Notez bien qu\'alors ce nom est invariant, et en particulier qu\'il ne sera pas traduit.');
...
define('COM_SH404SEF_TT_INSERT_IJOOMLA_MAG_ARTICLE_ID', 'Si <strong>activé</strong>, le titre d\'un article dans une URL sera toujours précédé de l\'identifiant interne de cet article. Par exemple: <br /> monsite.com/Joomla-magazine/<strong>56</strong>-titre-de-super-article.html');
define('COM_SH404SEF_TT_INSERT_IJOOMLA_MAG_ISSUE_ID', 'Si <strong>Activé</strong>, l\'identifiant interne unique du numéro sera inséré avant le titre, afin d\'être sûr qu\'il soit unique.');
define('COM_SH404SEF_TT_INSERT_IJOOMLA_MAG_MAGAZINE_ID', 'Si <strong>activé</strong>, le titre du magazine dans une URL sera toujours précédé de l\'identifiant interne de ce magazine<br />par exemple : monsite.com/<strong>6</strong>-nom du magazine/titre-de-mon-article.html.');
define('COM_SH404SEF_TT_INSERT_IJOOMLA_MAG_NAME', 'Si <strong>Activé</strong>, le nom du magazine (c\'est à dire le titre de l\'élément de menu qui y conduit), sera systématiquement ajouté au début des URLs sef');
define('COM_SH404SEF_TT_INSERT_NUMERICAL_ID', 'Si <strong>Activé</strong>, un identificateur numérique sera inséré dans l\'URL, pour faciliter son inclusion dans des services de nouvelles comme Google news. l\'identifiant aura le format suivant : 2007041100000, avec 20070411 la date de création de l\'article et 00000 l\'identifiant unique interne à Joomla de l\'article. Pensez à mettre à jour la date de création de votre article lorsque vous le publiez une fois terminé. Par contre, vous ne devrez plus changer cette date de création une fois l\'article publié.');
define('COM_SH404SEF_TT_INSERT_NUMERICAL_ID_CAT_LIST', 'l\'identifiant numérique sera seulement inséré dans les URL des articles des catégories que vous sélectionnez ici. Vous pouvez sélectionner plusieurs catégories en apuuyant et maintenant la touche Ctrl avant de cliquer sur le nom d\'une catégorie.');
define('COM_SH404SEF_TT_INSERT_PRODUCT_ID', 'Si activé, le nom d\'un produit dans une URL sera toujours précédé de l\'identifiant interne de ce produit<br />Par exemple, monsite.com/3-mon-tres-beau-produit.html.<br />c\'est utile en particulier si vous n\'utilisez pas tous les noms de catégories, car des produits dans des catégories différentes peuvent porter le même nom. Notez bien que l\'on parle ici de l\'identifiant interne du produit, qui est toujours unique, et non du code produit (SKU) que vous entrez pour chaque produit.');
...
define('COM_SH404SEF_TT_REDIRECT_JOOMLA_SEF_TO_SEF', 'Si réglé sur <strong>Oui</strong>, sh404sef tentera de rediriger les URL SEF standard de JOOMLA (redirection 301) vers leur équivalent SEF s\'il existe déjà dans la base de données. S\'il n\'existe pas, il est créé, sauf si la page comporte des données transmises par POST, auquel cas rien n\'est fait. Attention: cette function operera la plupart du temps sans problème, mais peut quelquefois dysfonctionner pour certaines urls. Il est conseillé de la laisser sur off, ou de bien tester les url de sont site avant de passer en production.');
define('COM_SH404SEF_TT_REDIRECT_NON_SEF_TO_SEF', 'Si réglé sur <strong>Oui</strong>, les URL non-sef seront automatiquement redirigée (redirection 301) vers leur équivalent SEF s\'il existe déjà dans la base de données. S\'il n\'existe pas, il est créé, sauf si la page comporte des données transmises par POST, auquel cas rien n\'est fait.');
...
define('COM_SH404SEF_TT_SHOP_NAME', 'Quand le paramètre ci-dessus est activé, vous pouvez saisir un nom ici, qui sera alors employé à la place des titres de menus. Notez bien qu\'alors ce nom est invariant, et en particulier qu\'il ne sera pas traduit.');
...
define('COM_SH404SEF_TT_VM_INSERT_CATEGORIES', 'Si réglé sur <strong>Aucune</strong>, aucun nom de catégorie ne sera inséré dans les URL sef menant à une page produit, par exemple : <br /> monsite.com/joomla-cms.html<br />Si réglé sur <strong>La dernière seulement</strong>, le nom de la catégorie à laquelle appartient le produit sera inséré dans l\'URL sef, par exemple: <br /> monsite.com/php-mysql/joomla-cms.html<br />Si réglé sur <strong>Toutes les catégories imbriquées</strong>, le nom de toute la succession de catégories auxquelles appartient le produit sera inséré, par exemple : <br /> monsite.com/logiciels/cms/php-mysql/joomla-cms.html');
define('COM_SH404SEF_TT_VM_INSERT_CATEGORY_ID', 'Si activé, le nom d\'une catégorie sera toujours précédé dans les URL sef menant à une page produit d\'un identifiant unique, par exemple : <br /> monsite.com/2-logiciels/6-cms/2-php-mysql/joomla-cms.html');
define('COM_SH404SEF_TT_VM_INSERT_FLYPAGE', 'Si activé, le nom de la flypage sera inséré dans l\'URL menant à un produit. Cela peut être désactivé si vous n\'utilisez qu\'une seule flypage, et si vous n\'utilisez pas le bouton PDF.');
define('COM_SH404SEF_TT_VM_INSERT_MANUFACTURER_ID', 'Si activé, le nom d\'un fabricant dans une URL sera toujours précédé de l\'identifiant interne de ce fabricant<br />par exemple : monsite.com/6-nom-du-fabricant/mon-tres-beau-produit.html.');
define('COM_SH404SEF_TT_VM_INSERT_MANUFACTURER_NAME', 'Si activé, le nom du fabricant, s\'il y en a un pour ce produit, est inséré dans l\'URL sef pour toutes les liens menant à l\'affichage d\'un produit.<br />Par exemple : monsite.com/nom-du-fabricant/nom-du-produit.html');
define('COM_SH404SEF_TT_VM_INSERT_SHOP_NAME', 'Si activé, le nom de la boutique (c\'est à dire le titre de l\'élément de menu qui y conduit), sera systématiquement ajouté au début des URLs sef.');
...
define('COM_SH404SEF_TT_DOCMAN_INSERT_NAME', 'Si <strong>Activé</strong>, le titre de l\'élément de menu qui conduit à DOCMan sera systématiquement ajouté au début des URLs sef');
define('COM_SH404SEF_DOCMAN_NAME', 'Nom DOCMan par défaut');
define('COM_SH404SEF_TT_DOCMAN_NAME', 'Quand le paramètre précédent est activé, vous pouvez saisir un nom, qui sera alors employé à la place du titre de l\'élément de menu. Notez bien qu\'alors ce nom est invariant, et en particulier qu\'il ne sera pas traduit.');
define('COM_SH404SEF_DOCMAN_INSERT_DOC_ID', 'Insérer identifiant document');
define('COM_SH404SEF_TT_DOCMAN_INSERT_DOC_ID', 'Si activé, le titre d\'un document dans une URL sera toujours précédé de l\'identifiant interne de ce document, ce qui est utile quand plusieurs documents ont le même nom.');
define('COM_SH404SEF_DOCMAN_INSERT_DOC_NAME', 'Insérer nom du document');
define('COM_SH404SEF_TT_DOCMAN_INSERT_DOC_NAME', 'Si activé, le nom du document sera inséré dans l\'URL sef pour tous les liens menant à une action sur ce document');
define('COM_SH404SEF_MYBLOG_TITLE', 'Configuration MyBlog');
define('COM_SH404SEF_MYBLOG_INSERT_NAME', 'Insérer nom MyBlog');
define('COM_SH404SEF_TT_MYBLOG_INSERT_NAME', 'Si <strong>Activé</strong>, le titre de l\'élément de menu qui conduit à MyBlog sera systématiquement ajouté au début des URLs sef');
define('COM_SH404SEF_MYBLOG_NAME', 'Nom Myblog par défaut');
define('COM_SH404SEF_TT_MYBLOG_NAME', 'Quand le paramètre précédent est activé, vous pouvez saisir un nom, qui sera alors employé à la place du titre de l\'élément de menu. Notez bien qu\'alors ce nom est invariant, et en particulier qu\'il ne sera pas traduit.');
define('COM_SH404SEF_MYBLOG_INSERT_POST_ID', 'Insérer identifiant post');
define('COM_SH404SEF_TT_MYBLOG_INSERT_POST_ID', 'Si activé, le titre du post dans une URL sera toujours précédé de l\'identifiant interne de ce post, ce qui est utile quand plusieurs posts ont le même nom.');
define('COM_SH404SEF_MYBLOG_INSERT_TAG_ID', 'Insérer identifiant balise');
define('COM_SH404SEF_TT_MYBLOG_INSERT_TAG_ID', 'Si activé, le nom d\'un tag dans une URL sera toujours précédé de l\'identifiant interne de ce tag, ce qui est utile quand plusieurs balises ont le même nom.');
define('COM_SH404SEF_MYBLOG_INSERT_BLOGGER_ID', 'Insérer identifiant blogueur');
define('COM_SH404SEF_TT_MYBLOG_INSERT_BLOGGER_ID', 'Si activé, le nom d\'un blogueur dans une URL sera toujours précédé de l\'identifiant interne de ce blogueur, ce qui est utile quand plusieurs blogueurs ont le même nom.');
...
define('COM_SH404SEF_TT_SELECT_REWRITE_MODE', 'Choix du mode de fonctionnement de sh404SEF.<br /><strong>avec .htaccess (mod_rewrite)</strong><br />Mode classique : vous devez avoir un fichier .htaccess, configuré en fonction de votre serveur<br /><strong>sans .htaccess (index.php)</strong><br /><strong>EXPERIMENTAL :</strong>Vous n\'avez pas besoin de fichier .htaccess. Ce mode met à profit la fonctionn PathInfo du serveur Apache. Les urls comportent la chaine /index.php/. Il est possible que les serveurs IIS acceptent ce mode de fonctionnement<br /><strong>sans .htaccess (index.php?)</strong><br /><strong>EXPERIMENTAL :</strong>Vous n\'avez pas besoin de fichier .htaccess. Ce mode est identique au précédent, mais la chaine insérée est /index.php?/. Il est possible que les serveurs IIS acceptent ce mode de fonctionnement<br />');
define('COM_SH404SEF_RECORD_DUPLICATES', 'Enregistrer URL dupliquées');
define('COM_SH404SEF_TT_RECORD_DUPLICATES', 'Si activé, sh404SEF enregistrera dans la base de données toutes les URLs non sef correspondant à la même SEF URL. Cela vous permettra de choisir celle que vous voulez utiliser, avec la fonction Gérer dupliquées dans l\'écran de visualisation des URL SEF.');
define('COM_SH404SEF_META_TITLE', 'Balise Titre');
define('COM_SH404SEF_TT_META_TITLE', 'Saisissez le texte à insérer dans la balise <strong>META Titre</strong> pour la page correspondant à l\'URL actuelle.');
define('COM_SH404SEF_META_DESC', 'Balise Description');
define('COM_SH404SEF_TT_META_DESC', 'Saisissez le texte à insérer dans la balise <strong>META Description</strong> pour la page correspondant à l\'URL actuelle. ');
define('COM_SH404SEF_META_KEYWORDS', 'Balise Keywords');
define('COM_SH404SEF_TT_META_KEYWORDS', 'Saisissez le texte à insérer dans la balise <strong>META Keywords</strong> pour la page correspondant à l\'URL actuelle. Chaque mot ou groupe de mots doit être séparé du précédent par une virgule.');
define('COM_SH404SEF_META_ROBOTS', 'Balise Robots');
define('COM_SH404SEF_TT_META_ROBOTS', 'Saisissez le texte à insérer dans la balise <strong>META Robots</strong> pour la page correspondant à l\'URL actuelle. Cette balise indique aux moteurs de recherche s\'ils doivent suivre les liens figurant sur la page, et s\'ils doivent en indexer le contenu. Exemples courants :<br /><strong>INDEX,FOLLOW</strong> : indexer le contenu de la page, et suivre les liens<br /><strong>INDEX,NO FOLLOW</strong> : indexer le contenu de la page, mais ne pas suivre les liens qu\'elle comporte<br /><strong>NO INDEX, NO FOLLOW</strong> : ne pas indexer le contenu de la page, et ne pas suivre les liens<br />');
define('COM_SH404SEF_META_LANG', 'Balise Language');
define('COM_SH404SEF_TT_META_LANG', 'Saisissez le texte à insérer dans la balise <strong>META http-equiv= Content-Language </strong> pour la page correspondant à l\'URL actuelle. ');
define('COM_SH404SEF_CONF_TAB_META', 'Meta/SEO');
define('COM_SH404SEF_CONF_META_DOC', 'sh404SEF est équipé de plugins pour la création <strong>automatique</strong> des balises META pour un certain nombre de composants. Ne les créez manuellement que si les valeurs calculées automatiquement ne vous satisfont pas!<br>');
define('COM_SH404SEF_REMOVE_JOOMLA_GENERATOR', 'Supprimer Joomla Generator');
define('COM_SH404SEF_TT_REMOVE_JOOMLA_GENERATOR', 'Si activé, balise meta Generator = Joomla sera supprimée de toutes les pages');
define('COM_SH404SEF_PUT_H1_TAG', 'Insérer des balises h1');
define('COM_SH404SEF_TT_PUT_H1_TAG', 'Si activé, les titres des articles normaux de Joomla seront placés entre des balises HTML h1. Il s\'agit des titres ayant des classes CSS commençant par contentheading.');
...
define('COM_SH404SEF_TT_NEWURL_META', 'Entrez l\'URL non SEF pour laquelle vous voulez saisir des balises Meta. ATTENTION: elle doit obligatoirement commencer par <strong>index.php</strong>!');
define('COM_SH404SEF_BAD_META', 'Veuillez vérifier vos saisies : données invalides.');
...
define('COM_SH404SEF_BAD_DUPLICATES_NOTHING_TO_DO', 'Cette URL est déjà l\'URL principale');
define('COM_SH404SEF_MAKE_MAIN_URL_OK', 'Opération réussie');
define('COM_SH404SEF_MAKE_MAIN_URL_ERROR', 'Echec lors de l\'opération');
...
define('COM_SH404SEF_TT_INSERT_CONTENT_TABLE_NAME', 'Si activé, le nom de l\'élément de menu qui mène à un tableau d\'articles sera inséré dans les URLs créées, afin de distinguer les liens de type blog de ceux de type Tableau');
define('COM_SH404SEF_CONTENT_TABLE_NAME', 'Nom tables par défaut');
define('COM_SH404SEF_TT_CONTENT_TABLE_NAME', 'Quand le paramètre précédent est activé, vous pouvez saisir un titre ici, qui sera alors employé à la place des titres de menus. Notez bien qu\'alors ce titre est invariant, et en particulier qu\'il ne sera pas traduit.');
define('COM_SH404SEF_REDIRECT_WWW', 'Redirection 301 www/non-www');
define('COM_SH404SEF_TT_REDIRECT_WWW', 'Si activé, sh404SEF effectuera une redirection 301 en cas d\'accès par une URL sans www au début si l\'adresse du site commence par www., ou en cas d\'accès par une URL ave www si l\'adresse du site ne commence pas par www. Permet d\'éviter des pénalités pour contenu dupliqué, et aussi certains dysfonctionnements au niveau du serveur ou de Joomla (éditeurs de texte notamment)');
define('COM_SH404SEF_INSERT_PRODUCT_NAME', 'Insérer nom du produit');
define('COM_SH404SEF_TT_INSERT_PRODUCT_NAME', 'Si activé, le nom du produit sera inséré dans l\'URL créée');
define('COM_SH404SEF_VM_USE_PRODUCT_SKU_124S', 'Insérer code produit');
define('COM_SH404SEF_TT_VM_USE_PRODUCT_SKU_124S', 'Si activé, le code produit (aussi appelé SKU par VirtueMart) sera inséré dans l\'URL créée.');

// V 1.2.4.t
define('COM_SH404SEF_DOCMAN_INSERT_CAT_ID', 'Insérer identifiant catégorie');
define('COM_SH404SEF_TT_DOCMAN_INSERT_CAT_ID', 'Si activé, le nom de catégorie dans une URL sera toujours précédé de l\'identifiant interne de cette catégorie, ce qui est utile quand plusieurs catégories ont le même nom.');
define('COM_SH404SEF_DOCMAN_INSERT_CATEGORIES', 'Insérer nom catégories');
define('COM_SH404SEF_TT_DOCMAN_INSERT_CATEGORIES', 'Si réglé sur <strong>Aucune</strong>, aucun nom de catégorie ne sera inséré dans les URLs sef, par exemple : <br /> monsite.com/joomla-cms.html<br />Si réglé sur <strong>La dernière seulement</strong>, le nom de la catégorie à laquelle appartient le document sera inséré dans l\'URL sef, par exemple: <br /> monsite.com/php-mysql/joomla-cms.html<br />Si réglé sur <strong>Toutes les catégories imbriquées</strong>, toute la succession de catégories auxquelles appartient le document sera insérée, par exemple : <br /> monsite.com/logiciels/cms/php-mysql/joomla-cms.html');
define('COM_SH404SEF_FORCED_HOMEPAGE', 'URL page accueil');
define('COM_SH404SEF_TT_FORCED_HOMEPAGE', 'Saisissez ici une URL pour la page d\'accueil. A utiliser si vous avez mis en place une \'splash page\' de type index.html, qui s\'affiche lorsque vous accédez à www.mondomaine.fr. Saisissez dans ce cas pour ce paramètre : www.mondomaine.fr/index.php (pas de / à la fin), de manière à ce que le site Joomla s\'affiche lorsque l\'on clique sur le lien Accueil du menu principal');
define('COM_SH404SEF_INSERT_CONTENT_BLOG_NAME', 'Insérer nom blog articles');
define('COM_SH404SEF_TT_INSERT_CONTENT_BLOG_NAME', 'Si activé, le nom de l\'élément de menu qui mène à un affichage de type blog d\'articles sera inséré dans les URLs créées, afin de distinguer les liens de type blog de ceux de type Tableau');
define('COM_SH404SEF_CONTENT_BLOG_NAME', 'Nom blogs par défaut');
define('COM_SH404SEF_TT_CONTENT_BLOG_NAME', 'Quand le paramètre précédent est activé, vous pouvez saisir un titre ici, qui sera alors employé à la place des titres de menus. Notez bien qu\'alors ce titre est invariant, et en particulier qu\'il ne sera pas traduit.');
define('COM_SH404SEF_MTREE_TITLE', 'Configuration Mosets Tree');
define('COM_SH404SEF_MTREE_INSERT_NAME', 'Insérer nom MTree');
define('COM_SH404SEF_TT_MTREE_INSERT_NAME', 'Si <strong>Activé</strong>, le titre de l\'élément de menu qui conduit à Mosets Tree sera systématiquement ajouté au début des URL sef');
...
define('COM_SH404SEF_TT_MTREE_INSERT_LISTING_ID', 'Si activé, le titre d\'une entrée dans une URL sera toujours précédé de l\'identifiant interne de cette entrée, ce qui est utile quand plusieurs peuvent avoir le même nom.');
define('COM_SH404SEF_MTREE_PREPEND_LISTING_ID', 'Identifiant devant nom');
define('COM_SH404SEF_TT_MTREE_PREPEND_LISTING_ID', 'Si activé, et que le paramètre précédent l\'est aussi, l\'identifiant sera inséré AVANT le nom. Sinon, il sera inséré APRES le nom de l\'entrée.');
define('COM_SH404SEF_MTREE_INSERT_LISTING_NAME', 'Insérer nom entrée');
define('COM_SH404SEF_TT_MTREE_INSERT_LISTING_NAME', 'Si activé, le nom d\'une entrée sera inséré dans l\'URL sef pour tous les liens menant à une action sur cette entrée');
...
define('COM_SH404SEF_TT_INSERT_IJOOMLA_NEWSP_NAME', 'Si <strong>Activé</strong>, le titre de l\'élément de menu qui conduit à iJoomla News Portal sera systématiquement ajouté au début des URL sef');
...
define('COM_SH404SEF_TT_INSERT_IJOOMLA_NEWSP_CAT_ID', 'Si activé, le titre d\'une catégorie dans une URL sera toujours précédé de l\'identifiant interne de cette catégorie, ce qui est utile quand plusieurs peuvent avoir le même nom.');
define('COM_SH404SEF_INSERT_IJOOMLA_NEWSP_SECTION_ID', 'Insérer identifiant de section');
define('COM_SH404SEF_TT_INSERT_IJOOMLA_NEWSP_SECTION_ID', 'Si activé, le titre d\'une section dans une URL sera toujours précédé de l\'identifiant interne de cette section, ce qui est utile quand plusieurs peuvent avoir le même nom.');
define('COM_SH404SEF_REMO_TITLE', 'Configuration Remository');
define('COM_SH404SEF_REMO_INSERT_NAME', 'Insérer nom Remository');
define('COM_SH404SEF_TT_REMO_INSERT_NAME', 'Si <strong>Activé</strong>, le titre de l\'élément de menu qui conduit à Remository sera systématiquement ajouté au début des URL sef');
define('COM_SH404SEF_REMO_NAME', 'Nom Remository par défaut');
define('COM_SH404SEF_CB_SHORT_USER_URL', 'Accès infos par URL courte');
define('COM_SH404SEF_TT_CB_SHORT_USER_URL', 'Si <strong>Activé</strong>, l\'utilsateur pourra accéder à son profil par une URL courte, du type monsite.fr/pseudo. Bien faire attention lors de l\'activation de cette option que le pseudonyme de l\'utilisateur ne puisse pas générer de conflit avec d\'autres URLs du site.');
define('COM_SH404SEF_NEW_HOME_META', 'Meta page accueil');
define('COM_SH404SEF_CONF_ERASE_HOME_META', 'Confirmez-vous l\'effacement des balises Titre et meta pour la page d\'accueil ?');
define('COM_SH404SEF_UPGRADE_TITLE', 'Configuration des mises à jour');
define('COM_SH404SEF_UPGRADE_KEEP_URL', 'Conserver les URLs auto');
define('COM_SH404SEF_TT_UPGRADE_KEEP_URL', 'Si activé, les URLs SEF générées automatiquement par sh404SEF seront préservées si vous désinstallez le composant. Vous pourrez ainsi les retrouver intactes après avoir installé une nouvelle version.');
define('COM_SH404SEF_UPGRADE_KEEP_CUSTOM', 'Conserver les URL personnalisées, alias et shURLs');
define('COM_SH404SEF_TT_UPGRADE_KEEP_CUSTOM', 'Si activé, les URLs SEF personnalisées que vous avez pu créer seront préservées si vous désinstallez le composant. Vous pourrez ainsi les retrouver intactes après avoir installé un nouvelle version.');
define('COM_SH404SEF_UPGRADE_KEEP_META', 'Conserver balises titre et meta');
define('COM_SH404SEF_TT_UPGRADE_KEEP_META', 'Si activé, les balises Titre et les Meta que vous avez pu saisir au moyen de sh404SEF seront préservées si vous désinstallez le composant. Vous pourrez ainsi les retrouver intactes après avoir installé une nouvelle version.');
define('COM_SH404SEF_UPGRADE_KEEP_MODULES', 'Conserver paramètres des modules');
define('COM_SH404SEF_TT_UPGRADE_KEEP_MODULES', 'Si activé, les paramètres de publication actuels des modules shCustomTags et shJoomfish seront préservés lors d\'une mise à jour de sh404SEF.');
...
define('COM_SH404SEF_CONF_HONEYPOT_DOC', 'Le Projet Honey Pot est une initiative visant à protéger les sites internet des visites de robots créant des spams. Il met à disposition une base de données qui permet de comparer l\'adresse IP d\'un visiteur de votre site avec celles des robots identifiés par ailleurs. L\'utilisation de cette base de données requiert une clé d\'accès (gratuite) que vous pouvez vous procurer sur <a href="http://www.projecthoneypot.org/httpbl_configure.php">le site internet de Projet Honey Pot</a><br />(Vous devrez créer un compte avant de pouvoir obtenir votre clé d\'accés).');
define('COM_SH404SEF_ACTIVATE_SECURITY', 'Activer fonctions sécurité');
define('COM_SH404SEF_TT_ACTIVATE_SECURITY', 'Si activé, sh404SEF effectuera des contrôles sur le contenu des URLs demandées par les visiteurs, afin de protéger le site des attaques les plus courantes.');
define('COM_SH404SEF_LOG_ATTACKS', 'Enregistrer les attaques');
define('COM_SH404SEF_TT_LOG_ATTACKS', 'Si activé, les attaques identifiées seront enregistrées dans un fichier journal, dans lequel figurent notamment l\'adresse IP et la requête.<br />Il existe un fichier journal par mois. Ces fichiers journaux sont situés dans le dossier <racine du site>/administrator/com_sh404sef/logs. Vous pouvez les télécharger par FTP ou utiliser un utilitaire comme JoomlaExplorer pour les visualiser.');	            
define('COM_SH404SEF_CHECK_HONEY_POT', 'Utiliser Project Honey Pot');
define('COM_SH404SEF_TT_CHECK_HONEY_POT', 'Si activé, l\'adresse IP des visiteurs sera contrôlée en faisant appel au service HTTP:BL fournie par le Projet Hoeny Pot. Ce service est gratuit mais requiert une inscription et l\'obtention d\'une clé.');
define('COM_SH404SEF_HONEYPOT_KEY', 'Clé Projet Honey Pot');
define('COM_SH404SEF_TT_HONEYPOT_KEY', 'Si vous avez activé l\'option Utiliser Project Honey Pot, vous devez obtenir sur leur site une clé d\'identification. Saisissez ici la clé qu\'ils vous enverront par email (12 caractères)');	             
define('COM_SH404SEF_HONEYPOT_ENTRANCE_TEXT', 'Texte entrée alternative');
define('COM_SH404SEF_TT_HONEYPOT_ENTRANCE_TEXT', 'Si l\'adresse IP d\'un visiteur est identifié par Projet Honey Pot comme douteuse, l\'accès lui sera refusé. <br />Néanmoins, s\'il s\'agit malgré tout d\'un humain et non d\'un robot, il lui est proposé de cliquer sur un lien pour accéder malgré tout au site, ce que les robots ne seront pas capables de comprendre. <br />Vous pouvez modifier le texte par défaut proposé.' );	             
define('COM_SH404SEF_SMELLYPOT_TEXT', 'Texte piégeage');
define('COM_SH404SEF_TT_SMELLYPOT_TEXT', 'Si l\'adresse IP d\'un visiteur est identifiée par Projet Honey Pot comme douteuse, un lien est proposé vers un \'piège à robots\', afin de les identifier et de les ajouter à la base de données du projet Honey Pot. Un message est malgré tout affiché pour que les humains ne cliquent pas sur ce lien. ');
...
define('COM_SH404SEF_TT_IP_WHITE_LIST', 'Toute demande de page provenant d\'une adresse IP figurant sur cette liste (une par ligne) sera acceptée (sous réserve des contrôles précédents).<br />Vous pouvez utiliser des jokers, par exemple : 192.168.0.* désignera toutes les adresses de 192.168.0.0 à 192.168.0.255.');
define('COM_SH404SEF_IP_BLACK_LIST', 'Liste noire IP');
define('COM_SH404SEF_TT_IP_BLACK_LIST', 'Toute demande de page provenant d\'une adresse IP figurant sur cette liste (une par ligne) sera rejetée. Vous pouvez utiliser des jokers, par exemple : 192.168.0.* désignera toutes les adresses de 192.168.0.1 à 192.168.0.255.');
...
define('COM_SH404SEF_TT_MONTHS_TO_KEEP_LOGS', 'Si l\'enregistrement des attaques est activé, vous pouvez saisir ici le nbre de mois pendant lequel il faut les conserver. Si vous saisissez 1 mois par exemple, les données du mois en cours plus celle du mois dernier seront conservées. Celles plus anciennes seront effacées.');
define('COM_SH404SEF_ANTIFLOOD_TITLE', 'Configuration anti-flood');
define('COM_SH404SEF_ACTIVATE_ANTIFLOOD', 'Activer l`anti-flood');
define('COM_SH404SEF_TT_ACTIVATE_ANTIFLOOD', 'Si activé, sh404SEF vérifiera qu\'une même adresse IP ne réalise pas trop de requêtes consécutives rapprochées sur le site. Des attaques peuvent être menées par des pirates afin de rendre votre site indisponible de cette manière, en le surchargeant.');
...
define('COM_SH404SEF_TT_ANTIFLOOD_COUNT', 'Nombre de requêtes déclenchant un blocage de l`accès pour l\'adresse IP concernée. Par exemple, la saisie de Période = 10 et de Nombre = 4 signifie que si jamais une même adresse IP effectue au moins 4 requêtes sur moins de 10 secondes consécutives, l`accès lui sera refusé (renvoie d`un code de réponse 403 et d`une page quasiment blanche). Bien sûr, les autres visiteurs de votre site continueront eux à pouvoir y accéder.');
...
define('COM_SH404SEF_TT_INSERT_LANGUAGE_CODE_PER_LANG', 'Si réglé sur Oui, le code langue iso sera inséré dans les URL générées <strong>pour cette langue</strong>. Si réglé sur Non, le code iso ne sera jamais inséré. Si réglé sur Par défaut, le code iso sera inséré, sauf pour les URLs dans la langue par défaut du site.');
define('COM_SH404SEF_TT_TRANSLATE_URL_PER_LANG', 'Si réglé sur Oui, et que votre site est multilingue, les éléments constitutifs des URLs <strong>pour cette langue</strong> seront traduits dans la langue du visiteur, tel que permis par Joomfish. Si réglé sur non, les URLs seront entièrement dans la langue par défaut du site. Si réglé sur Par défaut, les URLs seront également traduites. Sans effet si votre site n\'est pas multilingue.');
define('COM_SH404SEF_TT_INSERT_LANGUAGE_CODE_GEN', 'Si activé, le code langue iso sera inséré dans les URLs générées, Vous pouvez également effectuer ci-dessous un réglage pour chaque langue.');
define('COM_SH404SEF_TT_TRANSLATE_URL_GEN', 'Si activé, et que votre site est multilingue, les éléments constitutifs des URLs seront traduits dans la langue du visiteur, tel que permis par Joomfish. Sinon, les URLs seront entièrement dans la langue par défaut du site. Sans effet si votre site n\'est pas multilingue. Vous pouvez également effectuer ci-dessous un réglage pour chaque langue.');
define('COM_SH404SEF_ADV_COMP_DEFAULT_STRING', 'Nom par défaut');
define('COM_SH404SEF_TT_ADV_COMP_DEFAULT_STRING', 'Si vous entrez un nom, il sera utilisé au début de chaque URl menant à ce composant. Normalement inutile, sauf pour compatibilité avec des URLs anciennes.');
define('COM_SH404SEF_TT_NAME_BY_COMP', '.<br /> Vous pouvez également saisir un nom qui sera utilisé à la place de l\'élément de menu. Pour cela, allez dans l\'onglet : Par composant. Notez bien qu\'alors ce nom est invariant, et en particulier qu\'il ne sera pas traduit.');
define('COM_SH404SEF_STANDARD_ADMIN', 'Cliquez ici pour l\'interface standard (affiche paramètres principaux)');
define('COM_SH404SEF_ADVANCED_ADMIN', 'Cliquez ici pour l\'interface avancée (affiche tous les paramètres disponibles)');
define('COM_SH404SEF_MULTIPLE_H1_TO_H2', 'Transformer h1 multiple en h2');
define('COM_SH404SEF_TT_MULTIPLE_H1_TO_H2', 'Si activé, et que plusieurs balises h1 existent dans la page, elles seront transformées en balises h2. S\'il n\'y en a qu\'une, elle ne sera pas modifiée.');
define('COM_SH404SEF_INSERT_NOFOLLOW_PDF_PRINT', 'Insérer \' nofollow \' sur liens PDF et Imprimer');
define('COM_SH404SEF_TT_INSERT_NOFOLLOW_PDF_PRINT', 'Si Activé, des instructions rel=nofollow seront ajoutées sur les liens créés par Joomla pour imprimer ou transformer un article en PDF. Cela permet d\'éviter la duplication de contenu dans les moteurs de recherche.');
define('COM_SH404SEF_INSERT_READMORE_PAGE_TITLE', 'Ajouter titre à Lire la suite...');
define('COM_SH404SEF_TT_INSERT_READMORE_PAGE_TITLE', 'Si Activé, et qu\'un article comporte un lien \'Lire la suite...\', le titre de l\'article sera inséré dans le lien affiché, pour améliorer le poids du lien dans les moteurs de recherche');
define('COM_SH404SEF_VM_USE_ITEMS_PER_PAGE', 'Présence sélection produits par page');
define('COM_SH404SEF_TT_VM_USE_ITEMS_PER_PAGE', 'Si Activé, les URLs seront adaptées pour permettre un bon fonctionnement des listes de sélection du nombre de produits affichés par page. Si vous n\'utilisez pas de ces listes déroulantes, ET que les URLs de votre site sont déjà enregistrées dans les moteurs de recherche, laissez à Non, pour conserver les mêmes URLs qu\'avant.');
define('COM_SH404SEF_CHECK_POST_DATA', 'Contrôler les données dans les formulaires');
define('COM_SH404SEF_TT_CHECK_POST_DATA', 'Si activé, les informations saisies dans les formulaires seront contrôlées. Cela peut quelquefois entraîner des blocages intempestifs si vous avez par exemple un forum dédié à Joomla, dans lequel les utilisateurs peuvent discuter de programmation Joomla ou similaire');
define('COM_SH404SEF_SEC_STATS_TITLE', 'Stat. de sécurité ');
...
define('COM_SH404SEF_TOTAL_IMG_TXT_CMD', 'Inclusion de fichiers distants');
...
define('COM_SH404SEF_TT_DEBUG_TO_LOG_FILE', 'Si activé, sh404SEF enregistrera dans un fichier un grand nombre d\'informations pour faciliter l\'identification de problèmes (bugs) dans le logiciel. <br/>Attention: Ce fichier peut rapidement devenir très volumineux. Et cette fonction peut ralentir significativement votre site. Elle ne doit donc être activée qu\'à bon escient. Cette fonction se désactivera automatiquement au bout d\'une heure. Pour la ré-activer, mettez-là sur Non, puis à nouveau sur Oui. Le fichier se trouve dans /administrator/components/com_sh404sef/logs/ ');

define('COM_SH404SEF_ALIAS_LIST', 'Liste d\'alias');
define('COM_SH404SEF_TT_ALIAS_LIST', 'Entrez ici une liste d\'alias pour cette URL. Entrez un seul alias par ligne, sous la forme:<br/>ancienne-url.html<br/>ou<br/>mon-autre-url.php?var=12&test=15<br>sh404SEF effectuera une redirection 301 vers la nouvelle URL si une de ces anciennes adresses est demandée.');
define('COM_SH404SEF_HOME_ALIAS', 'Alias page accueil');
define('COM_SH404SEF_TT_HOME_PAGE_ALIAS_LIST', 'Entrez ici une liste d\'alias pour la page d\'accueil. Entrez un seul alias par ligne, sous la forme:<br/>ancienne-url.html<br/>ou<br/>mon-autre-url.php?var=12&test=15<br>sh404SEF effectuera une redirection 301 vers la page d\'accueil si une de ces anciennes adresses est demandée.');
...
define('COM_SH404SEF_TT_OUTBOUND_LINKS_IMAGE', 'Les deux images disponibles ont un fond transparent. Choisissez l\'image noire si vos pages ont un fond blanc, et l\'image blanche si votre site a des pages à fond sombre. Les images utilisées sont /administrator/components/com_sef/images/external-white.png et external-black.png. Elles font 15x16 pixels.');

// V 1.3.3
define('COM_SH404SEF_DEFAULT_PARAMS_TITLE', 'Très avancé');
define('COM_SH404SEF_DEFAULT_PARAMS_WARNING', 'ATTENTION: ne modifiez le contenu de cette page que si vous savez ce que vous faites! En cas d\'erreur vous pouvez introduire des dysfonctionnements dans sh404SEF qu\'il vous sera ensuite très difficile de corriger.');

// V 1.0.12
define('COM_SH404SEF_USE_CAT_ALIAS', 'Utiliser alias de catégorie');
define('COM_SH404SEF_TT_USE_CAT_ALIAS', 'Si activé, sh404sef utilisera l\'alias d\'une catégorie plutôt que son nom partout où il en aura besoin dans une url');
define('COM_SH404SEF_USE_SEC_ALIAS', 'Utiliser alias de section');
define('COM_SH404SEF_TT_USE_SEC_ALIAS', 'Si activé, sh404sef utilisera l\'alias d\'une section plutôt que son nom partout où il en aura besoin dans une url');
define('COM_SH404SEF_USE_MENU_ALIAS', 'Utiliser alias de menu');
define('COM_SH404SEF_TT_USE_MENU_ALIAS', 'Si activé, sh404sef utilisera l\'alias d\'un élément de menu plutôt que son titre partout où il en aura besoin dans une url');
define('COM_SH404SEF_ENABLE_TABLE_LESS', 'Affichage sans table');
define('COM_SH404SEF_TT_ENABLE_TABLE_LESS', 'Si activé, sh404sef activera l\'affichage sans table (uniquement des div) quel que soit le template (gabarit) que vous utilisez. Vous ne devez pas avoir effacé le template Beez pour que cette option fonctionne. Le template Beez est installé par défaut avec Joomla.<br /><strong>ATTENTION</strong> : il vous faudra adapter les feuilles de style de votre gabarit en fonction de ce nouveau format de sortie');
...
// V 1.5.3
define('COM_SH404SEF_ALWAYS_APPEND_ITEMS_PER_PAGE', 'Toujours ajouter nbre élements par page');
define('COM_SH404SEF_TT_ALWAYS_APPEND_ITEMS_PER_PAGE', 'SI activé, sh404sef ajoutera systématiquement le nombre d\'éléments par page à la fin des urls de pagination. Par exemple, .../Page-2.html deviendra .../Page2-10.html, si le réglage actuel du nombre d\'élements par page est 10. Ceci est nécessaire par exemple lorsque vous activez les listes déroulantes permettant aux utilisateurs de choisir le nombre d\'articles à afficher par page.');
...
define('COM_SH404SEF_JCL_INSERT_EVENT_ID', 'Insérer id événement');
...
define('COM_SH404SEF_JCL_INSERT_CATEGORY_ID', 'Insérer catégorie événement');
...
define('COM_SH404SEF_TT_JCL_INSERT_DATE_IN_EVENT_VIEW', 'Si activé, la date de début d\'un événement sera insérée dans le lien menant à cet événement');
...
define('COM_SH404SEF_CONTENT_TITLE_SHOW_CAT', 'Insérer catégorie');
define('COM_SH404SEF_TT_CONTENT_TITLE_SHOW_CAT', 'Si activé, le titre de la catégorie à laquelle appartient l\'article sera inséré dans le titre de page');
...
define('COM_SH404SEF_TT_INSERT_ARTICLE_ID_TITLE', 'Si activé, l\'identifiant interne d\'un article sera ajouté à la fin des urls, pour s\'assurer que tous les articles sont accessibles même dans le cas où plusieurs articles ont exactement le même titre, ou génère la même url (après que le titre ait été nettoyé des caractères invalides, etc). Cet identifiant n\'a aucune valeur sur le plan de l\'optimisation pour les moteurs de recherche, et vous devriez plutôt essayer de vous assurer que tous vos articles ont des titres distincts. Si ce n\'est pas possible - par exemple si ce n\'est pas vous qui les saisissez, ce réglage peut malgré tout vous aider à être sûr que tous les articles soient accessibles individuellement, au prix d\'une moins bonne optimisation des urls');

// V 1.5.8

define('COM_SH404SEF_JS_TITLE', 'Configuration JomSocial ');
define('COM_SH404SEF_JS_INSERT_NAME', 'Insérer nom JomSocial');
define('COM_SH404SEF_TT_JS_INSERT_NAME', 'Si <strong>Oui</strong>, le titre de menu pointant sur la page principale de JomSocial sera ajouté à toutes les URL SEF JomSocial');
define('COM_SH404SEF_JS_INSERT_USER_NAME', 'Insérer le pseudo');
define('COM_SH404SEF_TT_JS_INSERT_USER_NAME', 'Si <strong>Oui</strong>, l\'identifiant utilisateur sera inséré aux URLs SEF. <strong>ATTENTION</strong>: Ceci peut accroître considérablement la taille de la base de données et ralentir le site si vous avez de nombreux utilisateurs inscrits.');
define('COM_SH404SEF_JS_INSERT_USER_FULL_NAME', 'Insérer nom complet');
define('COM_SH404SEF_TT_JS_INSERT_USER_FULL_NAME', 'Si  <strong>Oui</strong>, le nom complet de l\'utilisateur sera inséré dans les URLs SEF. <strong>ATTENTION</strong>: Ceci peut accroître considérablement la taille de la base de données et ralentir le site si vous avez de nombreux utilisateurs inscrits.');
define('COM_SH404SEF_JS_INSERT_GROUP_CATEGORY', 'Insérer catégorie du groupe');
define('COM_SH404SEF_TT_JS_INSERT_GROUP_CATEGORY', 'Si <strong>Oui</strong>, la catégorie du groupe d\'utilisateurs sera insérée dans les URLs SEF où le nom du groupe est utilisé.');
define('COM_SH404SEF_JS_INSERT_GROUP_CATEGORY_ID', 'Insérer ID catégorie de groupe');
define('COM_SH404SEF_TT_JS_INSERT_GROUP_CATEGORY_ID', 'Si <strong>Oui</strong>, l\'identifiant de catégorie de groupes d\'utilisateurs sera préfixé au nom de cette catégorie  <strong>quand l\'option précédente est aussi réglée sur Oui</strong>, au cas où 2 catégories ont le même nom.');
define('COM_SH404SEF_JS_INSERT_GROUP_ID', 'Insérer ID de groupe');
define('COM_SH404SEF_TT_JS_INSERT_GROUP_ID', 'Si <strong>Oui</strong>, l\'identifiant de groupe d\'utilisateurs sera préfixé au nom du groupe, au cas où 2 groupes auraient le même nom.');
define('COM_SH404SEF_JS_INSERT_GROUP_BULLETIN_ID', 'Insérer ID de bulletin');
define('COM_SH404SEF_TT_JS_INSERT_GROUP_BULLETIN_ID', 'Si <strong>Oui</strong>, l\'identificateur du bulletin du groupe d\'utilisateurs sera préfixé au nom du bulletin au cas où 2 bulletins auraient le même nom.');
define('COM_SH404SEF_JS_INSERT_DISCUSSION_ID', 'Insérer ID de fil de discussion');
define('COM_SH404SEF_TT_JS_INSERT_DISCUSSION_ID', 'Si <strong>Oui</strong>, l\'identificateur de discussion d\'un groupe d\'utilisateurs sera préfixé au nom de la discussion au cas où 2 discussions auraient le même nom.');
define('COM_SH404SEF_JS_INSERT_MESSAGE_ID', 'Insérer ID de message');
define('COM_SH404SEF_TT_JS_INSERT_MESSAGE_ID', 'Si <strong>Oui</strong>, l\'identificateur d\'un message sera préfixé au nom du message au cas où 2 messages auraient le même sujet.');
define('COM_SH404SEF_JS_INSERT_PHOTO_ALBUM', 'Insérer nom d\'album');
define('COM_SH404SEF_TT_JS_INSERT_PHOTO_ALBUM', 'Si <strong>Oui</strong>, le nom de l\'album auquel elle appartient sera inséré dans les URLs d\'une photo ou d\'un ensemble de photos.');
define('COM_SH404SEF_JS_INSERT_PHOTO_ALBUM_ID', 'Insérer ID d\'album');
define('COM_SH404SEF_TT_JS_INSERT_PHOTO_ALBUM_ID', 'Si <strong>Oui</strong>, l\'identificateur d\'un album sera préfixé à son nom au cas où 2 albums auraient le même sujet.');
define('COM_SH404SEF_JS_INSERT_PHOTO_ID', 'Insérer ID de photo');
define('COM_SH404SEF_TT_JS_INSERT_PHOTO_ID', 'Si <strong>Oui</strong>>, l\'identificateur d\'une photo sera préfixé à son nom au cas où 2 photos auraient le même sujet.');
define('COM_SH404SEF_JS_INSERT_VIDEO_CAT', 'Insérer nom de catégorie vidéo');
define('COM_SH404SEF_TT_JS_INSERT_VIDEO_CAT', 'Si <strong>Oui</strong>, le nom de la catégorie à laquelle elle appartient sera inséré dans les URLs SEF d\'une vidéo ou d\'un ensemble de vidéos.');
define('COM_SH404SEF_JS_INSERT_VIDEO_CAT_ID', 'Insérer ID de catégorie vidéo');
define('COM_SH404SEF_TT_JS_INSERT_VIDEO_CAT_ID', 'Si <strong>Oui</strong>, l\'identificateur d\'une catégorie de vidéo sera préfixé à son nom au cas où 2 catégories auraient le même sujet.');
define('COM_SH404SEF_JS_INSERT_VIDEO_ID', 'Insérer ID de vidéo');
define('COM_SH404SEF_TT_JS_INSERT_VIDEO_ID', 'Si <strong>Oui</strong>, un identificateur de vidéo sera préfixé au nom de la vidéo au cas où 2 vidéos auraient le même sujet.');
...
define('COM_SH404SEF_PAGE_NOT_FOUND_ITEMID', 'Itemid à utiliser pour la page 404');
define('COM_SH404SEF_TT_PAGE_NOT_FOUND_ITEMID', 'La valeur saisie ici,quand elle est différente de zéro,sert à afficher la page 404. Joomla utilise l\'Itemid pour choisir le template et les modules à afficher. L\'Itemid représente un élément de menu. On peut donc chercher les itemids dans la liste des menus.');
//define('', '');