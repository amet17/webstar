...
define('COM_SH404SEF_VIEW404DESC','This page will show you a list of requests made to your web site by users that ended up being for a non-existing page. You\'ll be able to purge those records - after carefully cheching whether they result from simple typos or possibly from broken links on your sites');
...
define('COM_SH404SEF_UPGRADE_KEEP_CUSTOM', 'Preserve custom URL, aliases, shURLs');
