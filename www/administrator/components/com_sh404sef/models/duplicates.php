 ...
 * @version     $Id: duplicates.php 1819 2011-02-23 17:38:01Z silianacom-svn $
 */
    ...
    try {
      ...
      if (!empty( $previousMains)) {
        foreach( $previousMains as $previousMain) {
          ...
          Sh404sefHelperDb::update( '#__sh404SEF_meta', array('newurl' => $newMain->newurl), array( 'newurl' => $previousMain->newurl));
