 ...
 * @version     $Id: shSEFConfig.class.php 1945 2011-05-24 08:00:51Z silianacom-svn $
 */
...
class shSEFConfig {
  ...
  var $compEnablePageId = array( 'com_contact', 'com_content', 'com_newsfeeds', 'com_poll', 'com_user', 'com_weblinks');
  ...
  function shSEFConfig() {
    ...
    if (isset($insertContactCat))
    $this->insertContactCat = $insertContactCat;
...
// 2.2.6.973 - dev.anything-digital.com/sh404SEF/
...
// DO NOT REMOVE THIS LINE'."\n";
  ...
  function saveConfig($return_data=0) {
    ...
    if ($return_data == 1) {
      ...
      shSaveFile(sh404SEF_ABS_PATH . 'media/sh404_upgrade_conf_security/sh404SEF_IP_white_list.dat',
      $this->ipWhiteList);
      shSaveFile(sh404SEF_ABS_PATH . 'media/sh404_upgrade_conf_security/sh404SEF_IP_black_list.dat',
      $this->ipBlackList);
      shSaveFile(sh404SEF_ABS_PATH . 'media/sh404_upgrade_conf_security/sh404SEF_uAgent_white_list.dat',
      $this->uAgentWhiteList);
      shSaveFile(sh404SEF_ABS_PATH . 'media/sh404_upgrade_conf_security/sh404SEF_uAgent_black_list.dat',
