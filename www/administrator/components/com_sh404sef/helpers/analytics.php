 ...
 * @version     $Id: analytics.php 1757 2011-01-30 15:53:15Z silianacom-svn $
 */
...
class Sh404sefHelperAnalytics {
  ...
  public function verifyAuthResponse( $response) {
    ...
    if ($status != 200) {
      throw new Sh404sefExceptionDefault( JText16::_('COM_SH404SEF_ERROR_AUTH_ANALYTICS'));
    }
  }
  ...
  public static function getReferralLabel( $rawReferralType) {
    ...
    switch ($rawReferralType) {
      ...
      case '(none)':
        $label = JText16::_('COM_SH404SEF_ANALYTICS_REF_LABEL_DIRECT');
        break;
      case 'organic':
        $label = JText16::_('COM_SH404SEF_ANALYTICS_REF_LABEL_ORGANIC');
        break;
      case 'referral':
        $label = JText16::_('COM_SH404SEF_ANALYTICS_REF_LABEL_REFERRAL');
        break;
      default:
  ...
  public static function getDataTypeTitle() {
    ...
    $label = JText16::_( 'COM_SH404SEF_ANALYTICS_DATA_' . strtoupper( $dataTypeString));
  ...
  public static function buildAnalyticsReportSelectList( $current, $name, $autoSubmit = false, $addSelectAll = false, $selectAllTitle = '', $customSubmit = '') {
    ...
    $data = array(
    array( 'id' => 'dashboard', 'title' => JText16::_( 'COM_SH404SEF_ANALYTICS_REPORT_DASHBOARD'))
    ,array( 'id' => 'visits', 'title' => JText16::_( 'COM_SH404SEF_ANALYTICS_REPORT_VISITS'))
    ,array( 'id' => 'sources', 'title' => JText16::_( 'COM_SH404SEF_ANALYTICS_REPORT_SOURCES'))
    ,array( 'id' => 'keywords', 'title' => JText16::_( 'COM_SH404SEF_ANALYTICS_REPORT_KEYWORDS'))
    ,array( 'id' => 'urls', 'title' => JText16::_( 'COM_SH404SEF_ANALYTICS_REPORT_URLS'))
    ,array( 'id' => 'equipment', 'title' => JText16::_( 'COM_SH404SEF_ANALYTICS_REPORT_VISITORS_EQUIPMENT'))
    );
  ...
  public static function buildAnalyticsGroupBySelectList( $current, $name, $autoSubmit = false, $addSelectAll = false, $selectAllTitle = '', $customSubmit = '') {
    ...
    // available reports, should not be hardcoded though !
    $data = array(
    array( 'id' => 'ga:year,ga:month,ga:week,ga:day', 'title' => JText16::_( 'Day'))
    ,array( 'id' => 'ga:year,ga:month,ga:week', 'title' => JText16::_( 'Week'))
    ,array( 'id' => 'ga:year,ga:month', 'title' => JText16::_( 'Month'))
    );
