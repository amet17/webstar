 ...
 * @version     $Id: view.html.php 1741 2011-01-20 18:09:13Z silianacom-svn $
 */
...
class Sh404sefViewUrls extends JView {
  ...
  private function _makeToolbarDefault( $params = null) {
    ...
    $bar->appendButton( 'Shpopuptoolbarbutton', 'import', $url, JText16::_( 'COM_SH404SEF_IMPORT_BUTTON'), $msg='', $task='import', $list = false, $hidemenu=true, $params);
    ...
    $bar->appendButton( 'Shpopuptoolbarbutton', 'export', $url, JText16::_( 'COM_SH404SEF_EXPORT_BUTTON'), $msg='', $task='export', $list = false, $hidemenu=true, $params);
