 ...
 * @version     $Id: default.php 1864 2011-03-11 20:45:24Z silianacom-svn $
 */
...
<table class="adminlist">
  ...
  <tr <?php $x++; echo ( ( $x % 2) ? '' : ' class="row1"' ); ?>>
    ...
    <td><?php echo JHTML::_('tooltip', JText16::_('COM_SH404SEF_TT_REPLACEMENTS') ); ?></td>
  </tr>
...
<table class="adminlist">
  ...
  $x++;
  echo Sh404sefViewHelperConfig::shYesNoParamHTML( $x,
  JText16::_('COM_SH404SEF_STOP_CREATING_SHURLS'),
  JText16::_('COM_SH404SEF_TT_STOP_CREATING_SHURLS'),
  $this->lists['stopCreatingShurls'] );
  $x++;
  echo Sh404sefViewHelperConfig::shTextParamHTML( $x,
  JText16::_('COM_SH404SEF_SHURL_BLACKLIST'),
  JText16::_('COM_SH404SEF_TT_SHURL_BLACKLIST'),
        'shurlBlackList',
  $this->sefConfig->shurlBlackList, 60, 255 );
  $x++;
  echo Sh404sefViewHelperConfig::shTextParamHTML( $x,
  JText16::_('COM_SH404SEF_SHURL_NON_SEF_BLACKLIST'),
  JText16::_('COM_SH404SEF_TT_SHURL_NON_SEF_BLACKLIST'),
        'shurlNonSefBlackList',
  $this->sefConfig->shurlNonSefBlackList, 60, 255 ); 
  $x++;
  echo Sh404sefViewHelperConfig::shYesNoParamHTML( $x,
  JText16::_('COM_SH404SEF_INSERT_SHORTLINK_TAG'),
  JText16::_('COM_SH404SEF_TT_INSERT_SHORTLINK_TAG'),
  $this->lists['insertShortlinkTag'] );
  $x++;
  echo Sh404sefViewHelperConfig::shYesNoParamHTML( $x,
  JText16::_('COM_SH404SEF_INSERT_REV_CAN_TAG'),
  JText16::_('COM_SH404SEF_TT_INSERT_REV_CAN_TAG'),
  $this->lists['insertRevCanTag'] );
  $x++;
  echo Sh404sefViewHelperConfig::shYesNoParamHTML( $x,
  JText16::_('COM_SH404SEF_INSERT_ALT_SHORT_TAG'),
  JText16::_('COM_SH404SEF_TT_INSERT_ALT_SHORT_TAG'),
...
<table class="adminlist">
  ...
  $x++;
  echo Sh404sefViewHelperConfig::shYesNoParamHTML( $x,
  JText16::_('COM_SH404SEF_SLOW_SERVER'),
  JText16::_('COM_SH404SEF_TT_SLOW_SERVER'),
