 ...
 * @version     $Id: default.php 1739 2011-01-20 18:06:10Z silianacom-svn $
 */
...
<div id="cpanel">
  ...
  <div id="left" class="cp-block">
    ...
    <?php 
      ...
      $analyticsOutput = $pane->startPanel( JText16::_('COM_SH404SEF_ANALYTICS'), 'analytics' )
      ...
      // management icons
      echo $pane->startPanel( JText16::_('COM_SH404SEF_MANAGEMENT'), 'management' );
    ...
    <?php 
      ...
      // configuration icons
      echo $pane->startPanel( JText16::_('COM_SH404SEF_CONFIGURATION'), 'config' );
  ...
  <div id="right" class="cp-block">
    ...
    <?php 
      ...
      echo $pane->startPanel( JText16::_('COM_SH404SEF_QUICK_START'), 'qcontrol' );
