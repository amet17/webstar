 ...
 * @version     $Id: view.html.php 1758 2011-02-01 10:13:06Z silianacom-svn $
 */
...
class Sh404sefViewDuplicates extends JView {
 ...
 /**
  ...
  private function _makeToolbar( $params = null) {
    ...
    $bar->appendButton( 'Standard', 'main', JText16::_('COM_SH404SEF_DUPLICATES_MAKE_MAIN'), 'makemainurl', true, true );

    // other button are standards
    $bar->appendButton( 'Standard', 'back', JText16::_('COM_SH404SEF_BACK'), 'backPopup', false, false );
