 ...
 * @version     $Id: default.php 1853 2011-03-04 09:46:03Z silianacom-svn $
 */
        ...
        <tr class="<?php echo "row$k"; ?>">
          ...
          <td width="75%">
            <?php 
              ...
              echo '&nbsp;<a href="' . $this->escape($link) . '" target="_blank" title="' . JText16::_('COM_SH404SEF_PREVIEW') . ' ' . $this->escape($url->oldurl) . '">';
